...
public class navigation_act extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (itemId == R.id.home) {
            ...
            Intent intent = new Intent(navigation_act.this, MainActivity.class);
            startActivity(intent);
        } else if (itemId == R.id.profile) {
            Toast.makeText(this, "Profile clicked", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(navigation_act.this, profile_act.class);
            startActivity(intent);
        } else if (itemId == R.id.about_us) {
            Toast.makeText(this, "About Us clicked", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(navigation_act.this, about_us.class);
            startActivity(intent);
